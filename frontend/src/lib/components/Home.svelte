...
<section id="home" class="flex items-center justify-center min-h-screen bg-cover bg-center px-4 py-8" style="background-image: url('https://source.unsplash.com/random/1920x1080?nature')">
