...
<div
    class="search-panel w-full bg-white/90 dark:bg-gray-800/90 py-8 px-4 sm:py-16 sm:px-6 lg:px-8 my-4 sm:my-8 shadow"
>
    <div class="max-w-7xl mx-auto">
        <div class="container mx-auto px-4">
            <div class="container mx-auto px-4 max-w-4xl">
                <div
                    class="flex flex-col md:grid md:grid-cols-11 items-center gap-4 md:gap-2"
                >
                                ...
                                >
                                    {#each tagRow as tag}
                                        <button
                                            ...
                                            class="px-3 py-1 text-sm font-medium rounded-full transition-colors duration-200 ease-in-out {activeTags.includes(
                                                tag,
                                            )
